    ...
    <div name="home" className="w-full h-screen bg-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <p className="text-[#8892b0] py-6 max-w-[800px]">
          {t("Interested in projects that improve processes at all levels from large business scales to small daily activities. ")}
          {t("I am a creative problem solver, as my diverse background helps me to introduce solutions from different perspectives.")}
        </p>
        <div>
          ...
          <div className="container mx-auto text-white">
            <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 ">
              ...
              <li className="w-[160px] h-[60px] flex justify-between items-center shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-[#565f69]">
                <a
                className="flex justify-between items-center w-10/12 text-gray-300"
                href="https://www.linkedin.com/in/darkhan-iglikov-24a616157/overlay/1635505196130/single-media-viewer/"
                target="_blank"
                rel="noreferrer"
                >
